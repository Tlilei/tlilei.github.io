...
let res = ary.splice(1, 2, '2333', '哈哈哈');
console.log(res, ary); //=> [20,30] [10,'2333','哈哈哈', 40, 50]

// 实现增加
ary.splice(3, 0, '呵呵呵');
console.log(ary); //=>[10, "2333", "哈哈哈", "呵呵呵", 40, 50]
...
// 想验证ARY中是否包含'2333'
if (ary.indexOf('2333') === -1) {
	// 不包含
}
// 也可以直接使用ES6新提供的includes方法判断
if (ary.includes('2333')) {
	// 包含：如果存在返回的是TRUE
}
```
